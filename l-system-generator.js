...
var   REARG_FLAG$1 = 256;
  ...
  function isError(value) {
    ...
    return (objectToString$3.call(value) == errorTag) ||
...
var   nativeMin$3 = Math.min;
  ...
  function assignInDefaults(objValue, srcValue, key, object) {
    if (objValue === undefined ||
        (eq(objValue, objectProto$22[key]) && !hasOwnProperty$15.call(object, key))) {
      return srcValue;
    }
    return objValue;
  }
...
var   objectProto$23 = Object.prototype;
  ...
  function isPlainObject(value) {
    if (!isObjectLike(value) || objectToString$7.call(value) != objectTag$4) {
      return false;
    }
    ...
    return flatRest(function(funcs) {
      ...
      while (++index < length) {
        ...
        if (data && isLaziable(data[0]) &&
              data[1] == (ARY_FLAG$4 | CURRY_FLAG$6 | PARTIAL_FLAG$5 | REARG_FLAG$2) &&
...
var   nativeMin$5 = Math.min;
  ...
  function isString(value) {
    return typeof value == 'string' ||
      (!isArray(value) && isObjectLike(value) && objectToString$8.call(value) == stringTag$4);
  }
  ...
  function isBoolean(value) {
    return value === true || value === false ||
      (isObjectLike(value) && objectToString$10.call(value) == boolTag$4);
  }
...
var   setTag$6 = '[object Set]';
  ...
  function isNumber(value) {
    return typeof value == 'number' ||
      (isObjectLike(value) && objectToString$12.call(value) == numberTag$4);
  }
...
var   nativeMax$12 = Math.max;
  ...
  var rearg = flatRest(function(func, indexes) {
    return createWrap(func, REARG_FLAG$3, undefined, undefined, undefined, indexes);
  });
...
var   objectProto$36 = Object.prototype;
  ...
  /** Built-in value references. */
  var iteratorSymbol$1 = Symbol ? Symbol.iterator : undefined;
